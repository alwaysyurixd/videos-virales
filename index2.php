...
<div class="blog-wrap">
	...
	<div class="blog-grid">
		...
		<div class="post format-image box"> 
			...
			<h2 class="title"><?php echo "<a href='articulo-".$arrayFecha[1][0]."-".$arrayFecha[1][1]."_".$arrayTitulo[1]."-".$arrayId[1]."'>
				".$array[1]."</a>"; ?></h2>
			<blockquote><cite>Yuri Carranza</cite></blockquote>
			<div class="details">
		...
		<div class="post format-image box"> 
			...
			<h2 class="title"><?php echo "<a href='articulo-".$arrayFecha[2][0]."-".$arrayFecha[2][1]."_".$arrayTitulo[2]."-".$arrayId[2]."'>
				".$array[2]."</a>"; ?></h2>
			<blockquote><cite>Yuri Carranza</cite></blockquote>
			<div class="details">
		...
		<div class="post format-image box"> 
			...
			<h2 class="title"><?php echo "<a href='articulo-".$arrayFecha[3][0]."-".$arrayFecha[3][1]."_".$arrayTitulo[3]."-".$arrayId[3]."'>
				".$array[3]."</a>"; ?></h2>
			<blockquote><cite>Yuri Carranza</cite></blockquote>
			<div class="details">
		...
		<!-- Fin de un artículo --> 					
 		...
 		<div class="post format-image box"> 
			...
			<h2 class="title"><?php echo "<a href='articulo-".$arrayFecha[4][0]."-".$arrayFecha[4][1]."_".$arrayTitulo[4]."-".$arrayId[4]."'>
				".$array[4]."</a>"; ?></h2>
			<blockquote><cite>Yuri Carranza</cite></blockquote>
			<div class="details">
		...
		<div class="post format-image box"> 
			...
			<h2 class="title"><?php echo "<a href='articulo-".$arrayFecha[5][0]."-".$arrayFecha[5][1]."_".$arrayTitulo[5]."-".$arrayId[5]."'>
				".$array[5]."</a>"; ?></h2>
			<blockquote><cite>Yuri Carranza</cite></blockquote>
			<div class="details">
